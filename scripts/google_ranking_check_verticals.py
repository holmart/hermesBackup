# Script para verificar posicionamiento de páginas en Google por verticales y sus URLs
import requests
import json
import time
from bs4 import BeautifulSoup

# Lista de verticales y sus URLs correspondientes
verticals = [
    {'name': 'Fumigación', 'url': 'https://www.plusfumigaciones.com/'},
    {'name': 'Control de Plagas', 'url': 'https://www.fuseincolcolombia.com/'},
    {'name': 'Fumigación de Colombia', 'url': 'https://fumigacioncol.com/'},
    {'name': 'HVAC', 'url': 'https://www.carranzahvac.com/'},
    {'name': 'Limpieza', 'url': 'https://www.limpiezas.com/'},
    {'name': 'Consultoría Técnica', 'url': 'https://www.consultoriatecnica.co/'},
    {'name': 'Seguridad Industrial', 'url': 'https://www.seguridadeindustrial.com/'},
]
